...
class SubjectForm extends Form {
  ...
  public function initialize($entity = null, $options = array()) {
    ...
    $name->setLabel("*Nombre del tema");
    $name->addValidator(new SpaceValidatorForm(array('message' => 'El campo nombre se encuentra vacío')));
    $name->addValidator(new StringLength(array(
        'min' => 2, 
        'messageMinimum' => 'El nombre del tema es demasiado corto, debe tener al menos 2 carateres',
        'max' => 800,
        'messageMaximum' => 'El nombre del tema es demasiado largo, debe tener máximo 800 carateres',
    )));
    $this->add($name);
